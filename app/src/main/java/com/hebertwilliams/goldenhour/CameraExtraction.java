...
public class CameraExtraction extends ViewGroup implements SurfaceHolder.Callback {
    ...
    public CameraExtraction(Context context, int rotation) {
        ...
        //install surfaceholder. callback so we get notified
    ...
    public void switchCamera(Camera camera) {
        ...
        try {
            ...
            Log.e(TAG, "IOException caused by setPreviewDisplay()", ioe);
        }
    }
...
//        mCamera = Camera.open(cameraID);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        //set preview size
        //rotat resize reformat here
        Camera.Parameters param = mCamera.getParameters();
        Point previewSize = new Point(640, 640);
        ...
        try {
            ...
            Log.d("AndroidControlSurfaceView", "Error starting camera preview: " +
                    e.getMessage());
        }
    }
    ...
    public int setCameraDisplayOrientation(int cameraID, android.hardware.Camera camera) {
        ...
        if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
            ...
            result = (360 - result) % 360; //compensates image mirror
        } else { //back facing
